...
// --- LAYOUTS ---
export const DEFAULT_LAYOUT_HOME = "DEFAULT_LAYOUT_HOME";
// : LayoutItemVO[] = [
...
export const DEFAULT_LAYOUT_CATEGORIES = "DEFAULT_LAYOUT_CATEGORIES";
// : LayoutItemVO[] = [
//   { i: "stats", x: 0, y: 0, w: 12, h: 5, minW: 10, maxW: 12, minH: 4, maxH: 12, static: false },
//   { i: "form", x: 0, y: 5, w: 12, h: 4, minW: 8, maxW: 12, minH: 4, maxH: 10, static: false },
//   { i: "table", x: 0, y: 9, w: 12, h: 10, minW: 6, maxW: 12, minH: 8, maxH: 12, static: false },
// ];
