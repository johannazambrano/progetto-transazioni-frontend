...
<template>
  <section
    class="bg-white p-6 rounded-2xl shadow-md border border-gray-100 mb-6 transition-all"
  >
    ...
    <div class="flex flex-col md:flex-row gap-4 items-end">
      <div class="flex-1 w-full relative">
        ...
        <input
          ...
          type="text"
          placeholder="Es. Casa, Spese, Hobby..."
      ...
      <div class="w-full md:w-44">
        ...
        >
          <input
            ...
            type="color"
            class="w-10 h-full bg-transparent border-none cursor-pointer"
          />
          <span
            class="text-xs font-mono font-bold text-gray-500 flex-1 text-center"
            >{{ formData.colore.toUpperCase() }}</span
          >
        </div>
      </div>
